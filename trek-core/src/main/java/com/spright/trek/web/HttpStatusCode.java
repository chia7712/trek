...
public enum HttpStatusCode {
  ...
  PARTIAL_CONTENT(206),
  /**
   * {@code 207 Multi-Status} (WebDAV - RFC 2518). or
  ...
  /**
   * {@code 302 Moved Temporarily} (Sometimes {@code Found}) (HTTP/1.0 - RFC
   * 1945).
   */
  ...
  /**
   * Custom code. Indicates the specifieid file or directory is not found
   */
